...
class DataTransformation:
    ...
    def __init__(self):
        self.data_transformation_conig = DataTransformationConfig()
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Numerical columns encoding and standard scalar completed...")
    ...
    def initate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info(
                "Applying preprocessing object on traing and test dataframe"
                )
